...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin text-center restricted mt-auto">
            ...
            <h4 class="mt-2 mb-3 fw-normal ">Noida Institute of Engineering and Technology</h4>
            <p class="mt-2 mb-3 fw-normal h6 ">School Of Computer Application</p>
            <p class="mb-3 fw-bold text-bold text-wrap">The Four Snippets</p>
            <h4 class="mt-2 mb-3 fw-normal ">Guide Name</h4><p class="mt-2 mb-3 fw-normal h6 ">Priyanshu</p>
